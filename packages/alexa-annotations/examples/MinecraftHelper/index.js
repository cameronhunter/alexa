...
export default class MinecraftHelper {
  ...
  launch() {
    return ask(
      "Welcome to the Minecraft Helper. You can ask a question like, what's the recipe for a chest? ... Now, what can I help you with."
  ...
  help() {
    return ask(
      "You can ask questions about minecraft such as, what's the recipe for a chest, or, you can say exit... Now, what can I help you with?"
    ).reprompt(
      "You can say things like, what's the recipe for a chest, or you can say exit... Now, what can I help you with?"
    );
  }
